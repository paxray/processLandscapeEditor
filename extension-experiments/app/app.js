...
function openBoard(xml) {
  ...
  return modeler.importXML(xml).catch(function(err) {
    return console.error('could not import landscape board', err);
  });
}
