...
insertCSS('landscape-js.css', require('assets/landscape-js.css').default);
...
describe('Modeler', function() {
  ...
  describe('dependency injection', function() {
    ...
    it('should provide self as <landscapejs>', function() {
      ...
      return createModeler(simpleXML).then(function(result) {
        ...
        // then
        expect(modeler.get('landscapejs')).to.equal(modeler);
      });
    });
    ...
    it('should inject mandatory modules', function() {
      ...
      return createModeler(simpleXML).then(function(result) {
        ...
        expect(modeler.get('landscapeCopyPaste')).to.exist;
