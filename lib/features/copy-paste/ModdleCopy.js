 ...
 * @param {landscapeModdle} moddle
 */
export default function ModdleCopy(eventBus, landscapeFactory, moddle) {
...
ModdleCopy.prototype.copyProperty = function(property, parent, propertyName) {
  ...
  if (isObject(property) && property.$type) {
    ...
    copiedProperty = self._landscapeFactory.create(property.$type);
