...
import PositFactory from './landscapeFactory';
import landscapeUpdater from './landscapeUpdater';
...
export default {
  ...
  landscapeFactory: [ 'type', PositFactory ],
  landscapeUpdater: [ 'type', landscapeUpdater ],
