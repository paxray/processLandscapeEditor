 ...
 * @param {landscapeFactory} landscapeFactory
 * @param {TextRenderer} textRenderer
 */
export default function LabelBehavior(
    eventBus, modeling, landscapeFactory,
    textRenderer) {
  ...
  this.postExecute([ 'label.create' ], function(event) {
    ...
    if (!is(element.labelTarget || element, 'landscape:BoardElement')) {
      return;
    }
    ...
    if (!di.label) {
      di.label = landscapeFactory.create('landscapeDi:landscapeLabel', {
        bounds: landscapeFactory.create('dc:Bounds')
      });
    }
